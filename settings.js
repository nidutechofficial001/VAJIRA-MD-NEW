...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=zRFRmJpD#MBzBritX0ZJiYa_6XjwKCGLraatH2PtCKo_Uy3NYuRA' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94741938138' : process.env.OWNER_NUMBER,   
...
LOGO: process.env.LOGO || `https://ibb.co/HVr9Fc2` ,
